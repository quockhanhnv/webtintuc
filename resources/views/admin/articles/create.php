...
<body>
  ...
  <div class="bread-crumb container-fluid">
	...
	<div class="content container">
		<form method="post" action="http://localhost:8080/lamsao.com/articlecontroller/save" enctype="multipart/form-data">						<!-- thay bằng hàm location -->
			<div class="row">
				<div class="title col-md-3"><h3>Add new article</h3></div>
	...
	<script type="text/javascript" src="<?php echo location('js/jquery-3.1.1.js') ?>"></script>
	<script type="text/javascript" src="<?php echo location('js/bootstrap.min.js') ?>"></script>
	<script type="text/javascript" src="<?php echo location('js/ckeditor.js') ?>"></script>
